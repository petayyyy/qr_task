...
def save_to_csv(filename: str):
    ...
    global participant_name, qr_detection_times, attempt_duration
...
def reset_attempt():
    ...
    # Сбрасываем имя участника, если требуется
    if require_name:
        participant_name = ""
